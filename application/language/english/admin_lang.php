...
$lang['error_title_congratulation']		    = "¡Congratulations!";
$lang['error_title_important_news']			= "¡Important News!"; 
$lang['error_title_beware']		        	= "¡Beware!";
...
$lang['error_no_languages']                 = "There is no Languages added yet.";
$lang['error_no_links']                     = "There is no Links added yet.";
$lang['error_no_social_links']              = "There is no Social link added yet.";
$lang['error_no_posts']                     = "There is no Post added yet.";
$lang['error_no_page']                      = "There is no Page added yet.";
...
$lang['title_main']                         = 'Title'; 
$lang['title_slug']                         = 'URL (slug)';
$lang['title_description']                  = 'Description';
$lang['title_creation_date']                = 'Date Created';

$lang['title_url_target']					= 'Target';
$lang['title_visible']						= 'Visible';
$lang['title_order']						= 'Order';

// Dashboard
$lang['dashboard_page_name']                = 'Dashboard'; 
$lang['dashboard_index_page']               = 'Main Page'; 
...
// Settings
$lang['settings_hdr']				    	= "Settings";
$lang['settings_section_name']		    	= "Settings";
...
$lang['links_section_name']					= "Links";
$lang['links_index_page']					= "Main Page";
$lang['links_add_page']					    = "Add New Link";
$lang['links_edit_page']					= "Edit Link";
...
$lang['link_form_name_help']				= "Write down a Link Name";
$lang['link_form_url']						= "http://";
$lang['link_form_urlname']                  = "Link URL";
$lang['link_form_url_help']					= "Please write down any link starting with http:// o  https://";
$lang['link_form_url_target']	            = "Link Target";
$lang['link_form_target_help']              = "Choose a behaviour Link Target";
$lang['link_form_desc']						= "Description";
$lang['link_form_description_help']         = "Short description about Link";
$lang['link_form_position']					= "Order";
$lang['link_form_position_help']	    	= "Order";
$lang['link_form_target']					= "Target";
$lang['link_form_visibility']				= "Visibility";
$lang['link_form_visibility_help']			= "Choose Link's visibility";
...
// Categories
$lang['categories_section_name']			= "Categories";
$lang['categories_index_page']				= "Main Page";
$lang['categories_add_new']			    	= "Add New Category";
$lang['categories_edit_title']			    = "Update Category";
...
$lang['index_edit_new_cat']					= "Edit Category";
$lang['add_cat_subheading']					= "Please add the category information below.";
$lang['cat_form_name']						= "Category Name";
$lang['cat_form_name_help']                 = "Write down a Category Name"; // CREATE BY SVM
$lang['cat_form_url']						= "Slug is write down the same as above, all lowercase, no spaces";
$lang['cat_form_url_name_help']				= "Must write down the Category name same as above, all lowercase, no spaces";
$lang['cat_form_url_slug']				    = "Slug for Category"; // CREATE BY SVM
$lang['cat_form_desc']						= "Description";
$lang['cat_form_description_help']			= "Write down a short description for this Category"; // CREATE BY SVM
$lang['blank_window']						= "Open in new window";
$lang['same_window']						= "Open in same window";
$lang['visible']							= "Visible";
$lang['not_visible']						= "Hidden";
...
$lang['category_unique_error_message']		= 'The %s that you wrote is already used, please try again!';

// pages
$lang['pages_hdr']							= "Pages";
$lang['pages_index_page']					= "Main Page";
$lang['pages_section_name']					= "Pages";
$lang['pages_add_page']			    		= "Add New Page";
$lang['pages_edit_page']			    	= "Edit Page";
$lang['add_page_subheading']				= "Pages basic info";
$lang['optional_hdr']						= "Optional";
$lang['page_basics_label']					= "Basics";
...
$lang['posts_index_page']					= "Main Page";
$lang['posts_section_name']					= "Posts";
$lang['posts_add_page']			    		= "Add New Posts";
$lang['posts_edit_page']			    	= "Edit Posts";
$lang['optional_hdr']						= "Optional";
$lang['optional_help_text']					= "While the options below are optional, they are highly recommended and greatly help with Search Engine Optimization (SEO). We also generate meta tags for facebook and twitter with these values.";
...
$lang['posts_basics_label']					= "Basics";
$lang['posts_advanced_label']				= "Advanced";
...
$lang['navigation_section_name']			= "Navigation";
$lang['navigation_index_page']				= "Main Page";
$lang['navigation_add_page']				= "Create New Navigation";
$lang['navigation_edit_page']				= "Edit Navigation";
$lang['nav_new_hdr']						= "Create Navigation item";
$lang['nav_edit_hdr']						= "Edit Navigation item";
$lang['edit_nav_subheading']                = "Need this text";
...
$lang['redir_edit_title']					= "Edit Redirect";
$lang['redir_remove_btn']					= "Remove Redirect";
$lang['redir_from_label']					= "From"; 
$lang['redir_to_label']						= "To";
$lang['redir_type_label']		    		= "Type";
$lang['redir_http_label']					= "HTTP Redirect Type";
...
$lang['comments_section_name']				= "Comments";
$lang['comments_index_page']				= "Main Page";
$lang['comments_edit_page']			    	= "Edit Comments";
$lang['comments_section_name']				= "Comments";
$lang['comments_index_page']				= "Main Page";
...
$lang['themes_section_name']				= "Themes";
$lang['themes_index_page']					= "Main Page";
...
$lang['social_section_name']				= "Social";
$lang['social_index_page']					= "Main Page";
$lang['social_add_page']					= "Add New Social Link";
$lang['social_edit_page']	    			= "Edit Social Link";
$lang['social_hdr_help_txt']				= "Add, Edit, or Delete Links to your social media accounts.";
$lang['social_add_new']						= "Add New Social Link";
$lang['social_edit_btn']					= "Edit";
$lang['social_delete_btn']					= "Delete";
$lang['social_removed_success_resp']		= "Social Link Successfully Removed";
$lang['social_removed_fail_resp']			= "Could not Delete Social Link. Please try again.";
...
$lang['social_form_name']				    = "Social Name";
$lang['social_form_url']				    = "Social URL Link";
$lang['social_form_status']				    = "Status";
$lang['social_form_enabled']                = "Choose if should be enabled or not";

// languages
$lang['languages_hdr']						= "Languages";
$lang['languages_section_name']				= "Languages";
$lang['languages_index_page']				= "Main Page";
...
$lang['index_edit_language']			    = "Edit Language";
$lang['index_add_new_lag']			        = "Add New Language";
...
// permissions
$lang['permission_edit_page']               = "Edit Permission";
$lang['permission_section_name']            = "Permission";

$lang['permission_check_failed']			= "You must be an logged in and have permission to view this page.";
$lang['permission_form_name_label']         = "Name";
$lang['permission_form_name_help']          = "Permission's name";
$lang['permission_form_description_label']  = "Description";
$lang['permission_form_description_help']   = "Description permission";
...
$lang['groups_form_name']						= "Group Name";

$lang['groups_section_name']					= "Groups";
$lang['groups_edit_page']						= "Edit Group";
$lang['groups_add_page']						= "Add New Group";
$lang['groups_form_name_help']					= "Write down the group name";
$lang['groups_form_description']				= "Description";
$lang['groups_form_description_help']			= "Group Name description (optional)";
$lang['groups_form_button']						= "Create Group";
$lang['groups_form_edit_button']				= "Edit Group";

// Permissions
$lang['permissions_label']                          = "Permissions";

// users
$lang['users_form_header']		    				= "Users Management";
$lang['users_section_name']				    		= "Users";
$lang['users_index_page']				    		= "Main Page";
$lang['users_add_page']				    		    = "Add New User";
$lang['users_edit_page']				    		= "Edit User Info";
$lang['users_form_users_label']						= "Users";
$lang['users_form_groups_label']					= "Groups";
$lang['users_form_permission_label']				= "Permissions (Beta)";
...
$lang['users_form_edit_btn']                        = "Edit User";
$lang['users_form_yes_label']                       = "Yes";
$lang['users_form_no_label']                        = "No";
$lang['users_form_desactive_user_btn']              = "Desactivate User";
$lang['users_form_unrestricted_label']              = "Unrestricted"; 
$lang['users_form_none_label']                      = "None";
