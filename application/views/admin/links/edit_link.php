...
?>
        ...
        <div class="btn-group btn-breadcrumb">
			...
			<a href="#" class="btn btn-primary"><?php echo lang('link_edit_btn'); ?></a>
         </div>		 
		 <br /> &nbsp; <br /> 
    		...
    		<div class="panel panel-default">
			  	...
			  	<div class="panel-body">
                    ...
                    <fieldset>
					      ...
					      <div class="col-lg-10">						
			    		    <?php echo form_input( [ 'name'=> 'name', 'id' => 'name', 'class' => "form-control", 'placeholder' => lang('link_form_name'), 'value' => ($this->input->post('name'))?$this->input->post('name'):$link['name'] ] ); ?>
			    		...
			    		<div class="form-group<?php if (form_error('url')) { ?> has-error has-feedback <?php } ?>">
					      ...
					      <div class="col-lg-10">						
			    			<?php echo form_input(['name'=> 'url', 'id' => 'url', 'class' => "form-control", 'placeholder' => lang('link_form_url'), 'value' => ($this->input->post('url'))?$this->input->post('url'):$link['url'] ] ); ?>
			    		...
			    		<div class="form-group<?php if (form_error('target')) { ?> has-error has-feedback <?php } ?>">
			    			 <label for="target" class="col-lg-2 control-label"><?php echo $this->lang->line('link_form_url_target'); ?></label>
							  <div class="col-lg-10">
			    			<?php echo form_dropdown('target', ['_blank' => lang('blank_window'), '_self' => lang('same_window')], ($this->input->post('target'))?$this->input->post('target'):$link['target'], 'class="form-control"'); ?>
			    		...
			    		<div class="form-group<?php if (form_error('description')) { ?> has-error has-feedback <?php } ?>">
			    			 <label for="description" class="col-lg-2 control-label"><?php echo $this->lang->line('link_form_desc'); ?></label>
							  <div class="col-lg-10">
			    			<?php echo form_input(['name'=> 'description', 'id' => 'description', 'class' => "form-control", 'placeholder' => lang('link_form_desc'), 'value' => ($this->input->post('description'))?$this->input->post('description'):$link['description'] ] ); ?>
			    		...
			    		<div class="form-group<?php if (form_error('visible')) { ?> has-error has-feedback <?php } ?>">
						    <label for="visible" class="col-lg-2 control-label"><?php echo $this->lang->line('link_form_visibility'); ?></label>
							 <div class="col-lg-10">
			    			<?php echo form_dropdown('visible', ['1' => lang('visible'), '0' => lang('not_visible')], ($this->input->post('visible'))?$this->input->post('visible'):$link['visible'], 'class="form-control"'); ?>
			    		...
			    		<div class="form-group<?php if (form_error('position')) { ?> has-error has-feedback <?php } ?>">
							 ...
							 <div class="col-lg-10">
			    			<?php echo form_input(['name'=> 'position', 'id' => 'position', 'class' => "form-control", 'placeholder' => lang('link_form_position'), 'value' => ($this->input->post('position'))?$this->input->post('position'):$link['position'] ] ); ?>
						...
						<br /> &nbsp; <br />
			    		<input class="btn btn-lg btn-default btn-block" type="submit" value="<?php echo lang('edit_link_btn'); ?>">
			    	</fieldset>
			      	</form>
			    </div>
			</div>
